        ...
        */
        ...
        function activateMenuElement(name){
            if(options.menu){
                ...
                var elem=$(options.menu).find('[data-menuanchor="'+name+'"]');
                $(options.menu).find('[data-menu-parent="'+elem.attr('data-menu-parent')+'"]').addClass('hidden');
               document.getElementById('notscrollframe').classList.add('notclick');
